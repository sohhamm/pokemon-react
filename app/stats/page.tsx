              ...
              <CardContent className='p-6'>
                <div className='flex items-center justify-between mb-4'>
                  <h3 className='text-lg font-bold text-gray-800'>
                    Selected Pokemon ({selectedPokemon.length}/3)
                  </h3>
          ...
          <Card className='border-0 shadow-2xl bg-gradient-to-br from-white to-gray-50'>
            <CardContent className='flex flex-col items-center justify-center py-16'>
              ...
              <p className='text-gray-600 text-center max-w-md leading-relaxed'>
                Use the search box above to find and select Pokemon. Compare their stats, discover
                their strengths, and uncover insights through interactive visualizations.
              </p>
            </CardContent>
          </Card>
        ) : viewMode === 'individual' ? (
                        ...
                        >
                          <td className='py-4 px-6'>
                            <div className='flex items-center gap-3'>
                              <div
                                className={`w-10 h-10 rounded-full bg-gradient-to-r ${gradient} p-2 shadow-lg`}
                              >
                                <img
                                  src={
                                    pokemon.sprites.other['official-artwork'].front_default ||
