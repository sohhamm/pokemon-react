    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          <Link href="/">
            <Button variant="outline" size="sm" className="shadow-lg hover:shadow-xl transition-all bg-transparent">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-600">Master Pokemon battles with our interactive type matchup guide</p>
          </div>
        </div>
              ...
              <CardContent className="p-6 space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 2).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 2).length === 0 && (
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 0.5).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 0.5).length === 0 && (
                      <span className="text-gray-500 italic">None</span>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 0).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(selectedType, type) === 0).length === 0 && (
                      <span className="text-gray-500 italic">None</span>
                    )}
                  </div>
                </div>
            ...
            <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-cyan-50 overflow-hidden">
              ...
              <CardContent className="p-6 space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 2).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 2).length === 0 && (
                      <span className="text-gray-500 italic">None</span>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 0.5).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 0.5).length === 0 && (
                      <span className="text-gray-500 italic">None</span>
                    )}
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 0).map((type) => {
                      const gradient = getTypeColor(type)
                      return (
                        <Badge
                          key={type}
                    ...
                    {POKEMON_TYPES.filter((type) => getEffectiveness(type, selectedType) === 0).length === 0 && (
                      <span className="text-gray-500 italic">None</span>
                    )}
                  </div>
                </div>
