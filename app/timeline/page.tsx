      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='flex items-center gap-4 mb-8'>
          ...
          <div className='flex-1'>
            ...
            <p className='text-lg text-gray-600'>
              Journey through Pokemon history across generations
            </p>
          </div>
        </div>
        ...
        {currentGen && (
          <Card className='mb-8 border-0 shadow-2xl bg-gradient-to-br from-white to-gray-50 overflow-hidden'>
            <CardHeader
              className={`bg-gradient-to-r ${currentGen.color} text-white relative overflow-hidden`}
            >
              {/* Background Pattern */}
              ...
              <CardTitle className='relative flex items-center gap-4 text-2xl'>
                ...
                <div>
                  ...
                  <div className='text-base opacity-90 font-normal mt-1'>
                ...
                <div className={`p-6 rounded-xl bg-gradient-to-br ${currentGen.accentColor}`}>
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {currentGen.games.map(game => (
                      <Badge
                        key={game}
                        className={`bg-gradient-to-r ${currentGen.color} text-white shadow-md`}
                      >
                        Pokemon {game}
                      </Badge>
                    ))}
        ...
        {isLoading ? (
          <div className='text-center py-16'>
            ...
            <p className='text-sm text-gray-500 mt-2'>
              Discovering Pokemon from {currentGen?.year}
            </p>
          </div>
        ) : (
          <div className='space-y-6'>
            <div className='flex items-center justify-between'>
              <h2 className='text-2xl font-bold text-gray-800'>
                {currentGen?.name} Pokemon Collection
              </h2>
              <Badge
                className={`bg-gradient-to-r ${currentGen?.color} text-white text-lg px-4 py-2`}
              >
